...
// }
    ...
    _reder() {
        ...
        clockings = this._createStart(clockings);
        // clockings = this._createColor(clockings);
        // clockings = this._createDuration(clockings);     //تبدیل ساعت به ثانیه
        ...
        console.log('test2:', clockings[3]);                // تست اولیت رکورد تردد
